    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color_scheme', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='viki_web_cms.colorscheme', verbose_name='цветовая схема')),
            ],
            options={
                'verbose_name': 'Цвет',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='viki_web_cms.materialtype', verbose_name='материал'),
        ),
        migrations.CreateModel(
            name='ProductGroup',
            fields=[
                ...
                ('cover', models.FileField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(location='viki_web_cms/files/cover'), upload_to=django.core.files.storage.FileSystemStorage(location='viki_web_cms/files/cover'))),
                ('product_group_url', models.CharField(max_length=60)),
                ('priority', models.IntegerField(blank=True, null=True)),
                ('layout', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='viki_web_cms.layouttype')),
            ],
            options={
